  ...
  return (
    <div className="footer-column-animate" style={{ animationDelay: "200ms" }}>
      ...
      <div className="flex gap-4 mt-6">
        <a
          href="https://www.facebook.com/jmkrobotics/?locale=af_ZA"
        ...
        <a
          href="https://www.instagram.com/jmkrobotics/"
          className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          href="https://www.linkedin.com/company/jmk-robotics/"
          className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a
          href="https://www.youtube.com/@JMKRobotics"
          className="w-10 h-10 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center transition-colors"
        >
          <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
