  ...
  const services: Service[] = [
    {
      ...
      description: t("cards.installation.description"),
      scope: {
        title: t("cards.installation.scope.title"),
        items: [
          t("cards.installation.scope.item1"),
          t("cards.installation.scope.item2"),
          t("cards.installation.scope.item3"),
        ],
      },
      color: "primary",
    },
    {
      ...
      scope: {
        title: t("cards.maintenance.scope.title"),
        items: [
          t("cards.maintenance.scope.item1"),
          t("cards.maintenance.scope.item2"),
        ],
      },
      color: "accent",
    },
    {
      ...
      description: t("cards.repair.description"),
      scope: {
        title: t("cards.repair.scope.title"),
        items: [
          t("cards.repair.scope.item1"),
          t("cards.repair.scope.item2"),
          t("cards.repair.scope.item3"),
        ],
      },
      color: "primary",
    },
    {
      ...
      scope: {
        title: t("cards.design.scope.title"),
        items: [
          t("cards.design.scope.item1"),
          t("cards.design.scope.item2"),
          t("cards.design.scope.item3"),
        ],
      },
      color: "accent",
    },
    {
      ...
      title: t("cards.optimization.title"),
      description: t("cards.optimization.description"),
      scope: {
        title: t("cards.optimization.scope.title"),
        items: [
          t("cards.optimization.scope.item1"),
          t("cards.optimization.scope.item2"),
          t("cards.optimization.scope.item3"),
        ],
      },
      color: "primary",
    },
    {
      ...
      scope: {
        title: t("cards.consulting.scope.title"),
        items: [
          t("cards.consulting.scope.item1"),
          t("cards.consulting.scope.item2"),
          t("cards.consulting.scope.item3"),
          t("cards.consulting.scope.item4"),
        ],
      },
      color: "accent",
    },
            ...
            {services.map((service, index) => {
              ...
              return (
                <div
                  ...
                  className={`${
                    isVisible ? "animate-fade-in-up" : "opacity-0"
                  } bg-white shadow-xl hover:shadow-2xl transition-all duration-500 group overflow-hidden`}
                      ...
                      <div className="flex flex-col lg:flex-row gap-8 items-start">
                        ...
                        <div className="flex-shrink-0">
                          <div
                            className={`w-20 h-20 ${
                              isPrimary ? "bg-[#19165F]" : "bg-[#E53E3E]"
                            } flex items-center justify-center relative group-hover:scale-110 transition-transform duration-300`}
                          >
                            <Icon className="w-10 h-10 text-white" />
                            <div
                              className={`absolute inset-0 ${
                                isPrimary ? "bg-[#E53E3E]" : "bg-[#19165F]"
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-gradient-to-br from-gray-50 to-white p-8 border-2 border-gray-200 hover:border-[#19165F] transition-all duration-300 h-full">
                <div className="w-16 h-16 bg-[#19165F]/10 group-hover:bg-[#19165F] flex items-center justify-center mb-6 transition-colors duration-300">
                  <svg
                    className="w-8 h-8 text-[#19165F] group-hover:text-white transition-colors duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <h3 className="text-[#19165F] mb-4 group-hover:text-[#E53E3E] transition-colors duration-300">
                  {t("capabilities.items.assembly.title")}
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  {t("capabilities.items.assembly.description")}
                </p>
            ...
            >
              <div className="bg-gradient-to-br from-gray-50 to-white p-8 border-2 border-gray-200 hover:border-[#E53E3E] transition-all duration-300 h-full">
                <div className="w-16 h-16 bg-[#E53E3E]/10 group-hover:bg-[#E53E3E] flex items-center justify-center mb-6 transition-colors duration-300">
                  <svg
                    className="w-8 h-8 text-[#E53E3E] group-hover:text-white transition-colors duration-300"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  {t("capabilities.items.inspection.description")}
                </p>
                <div className="flex items-center gap-2 text-[#19165F] group-hover:text-[#E53E3E] transition-colors duration-300">
                  <div className="w-8 h-px bg-[#E53E3E]"></div>
                  <span className="text-sm uppercase tracking-wide">
            ...
            >
              <div className="bg-gradient-to-br from-gray-50 to-white p-8 border-2 border-gray-200 hover:border-[#19165F] transition-all duration-300 h-full">
                ...
                <h3 className="text-[#19165F] mb-4 group-hover:text-[#E53E3E] transition-colors duration-300">
                  {t("capabilities.items.custom.title")}
                </h3>
                <p className="text-gray-600 leading-relaxed mb-6">
                  {t("capabilities.items.custom.description")}
                </p>
                <div className="flex items-center gap-2 text-[#19165F] group-hover:text-[#E53E3E] transition-colors duration-300">
                  <div className="w-8 h-px bg-[#E53E3E]"></div>
                  <span className="text-sm uppercase tracking-wide">
      ...
      <section className="py-24 bg-gradient-to-br from-[#19165F] to-[#19165F]/90 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="space-y-8">
            ...
            <h2 className="text-white leading-tight">{t("cta.title")}</h2>
